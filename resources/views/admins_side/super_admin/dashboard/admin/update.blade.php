...
<div class="content-wrapper">
    ...
    <section action="" class="mt-3 content text-dark center p-3">
        <form action="{{ route('super-admin.dashboard.admin-update',['id' => $admin->id])}}" method="POST" autocomplete="off">
            @csrf
            <div class="form-group">
                <label for="full_name">Full Name</label>
                <input type="text" class="form-control" value="{{(old('full_name')? old('full_name'): $admin->full_name )}}" name="full_name" id="full_name" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{(old('email')? old('email'): $admin->email )}}" name="email" id="email" required>
                @if ($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{(old('phone_number')? old('phone_number'): $admin->phone_number )}}" name="phone_number" id="phone_number" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{(old('username')? old('username'): $admin->username )}}" name="username" id="username" required>
