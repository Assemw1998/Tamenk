            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-12">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="{{ route('super-admin.dashboard.admin-index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                @endif
                <!-- ./col -->
                ...
                <div class="col-lg-3 col-12">
                    ...
                    <div class="small-box bg-danger">
                        ...
                        <a href=" {{route("super-admin.dashboard.insurance-company-index")}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                @endif
                <!-- ./col -->
